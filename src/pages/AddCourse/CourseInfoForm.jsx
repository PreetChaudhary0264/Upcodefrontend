...
const CourseInfoForm = () => {
  ...
  <>
    ...
    <form
      ...
      className="bg-gray-800 p-8 rounded-2xl w-full max-w-4xl mx-auto space-y-8 shadow-lg border border-gray-700"
    >
      {/* Course Title */}
      ...
      <div className="flex flex-col">
        ...
        <textarea
          ...
          className="w-full text-white bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 min-h-[140px] focus:outline-none focus:ring-2 focus:ring-yellow-500 transition"
        />
      ...
      <div className="flex flex-col">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="bg-yellow-500 text-gray-900 font-semibold px-5 py-2 rounded-lg hover:bg-yellow-600 transition shadow-md"
          >
            Add
          </button>
        </div>
      ...
      <div className="flex flex-col">
        ...
        <div
          ...
          className="mt-2 w-full h-52 border-2 border-dashed border-gray-600 rounded-lg flex items-center justify-center cursor-pointer overflow-hidden relative hover:border-yellow-500 transition"
        >
          {thumbnailPreview ? (
            <>
              <img
