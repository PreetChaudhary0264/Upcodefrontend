...
const NestedView = () => {
    ...
    {course?.courseContent?.map((section, index) => (
      <div key={section._id} className="p-4">
        <details open className="group">
          <summary className="flex flex-col sm:flex-row sm:items-center justify-between px-3 py-2 cursor-pointer rounded-lg bg-gray-700 hover:bg-gray-600 transition">
          ...
          <button
            className="mt-4 sm:ml-10 flex items-center gap-2 text-yellow-400 hover:text-yellow-300 transition"
  ...
  {confirmationModal && (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 px-4">
      <div className="bg-gray-900 text-white rounded-lg shadow-xl p-6 w-full max-w-md border border-gray-700">
