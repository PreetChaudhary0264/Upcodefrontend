...
const Home = () => {
  return (
    <div>
      {/*section1 */}
      <div className=' bg-gray-900 relative  flex flex-col  w-[100%] items-center text-black justify-between '>
        <Link to={"/signup"}>
          <div className=' group mt-16 p-1 mx-auto rounded-full text-shadow-indigo-100 bg-blue-300 font-bold transition-all duration-200 hover:scale-95 w-fit'>
            <div className='flex flex-row items-center gap-2 rounded-full px-10 py-[5px] transition-all duration-200 group-hover:bg-blue-400'>
        ...
        <div className='mt-4 w-[50%] text-center text-lg font-bold text-gray-400'>
        ...
        {/* Video Section */}
         <div className="mt-10 flex justify-center">
          ...
          <video 
                className="w-[600px] max-w-full rounded-lg shadow-lg relative z-10 ml-10 mb-8" 
                src={codingVideo}  
                autoPlay 
                muted 
                loop
      ...
      {/*section2 */}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between px-10 py-16 gap-10">
          ...
          <h2 className="text-gray-800 text-2xl text-3xl font-bold mb-6">Why Choose Our Platform?</h2>
          ...
          <li className="text-gray-600 mt-8 font-semibold font-serif flex items-start gap-3">
           <span className="w-3 h-3 mt-2 rounded-full bg-yellow-400"></span>
          Interactive courses with projects, quizzes, and mentorship.
           </li>
          <li className="text-gray-600 font-semibold font-serif mt-8 flex items-start gap-3">
          <span className="w-3 h-3 mt-2 rounded-full bg-yellow-400"></span>
     ...
     <div className="md:w-1/2 flex justify-center">
      ...
      {/*section3 */}
          <section className="relative w-full h-[400px] flex items-center justify-center bg-white overflow-hidden">
      {/* Background Huge Text */}
      <h1 className="absolute text-[200px] md:text-[300px] font-extrabold text-gray-700 opacity-10 select-none leading-none">
        UpCode
      </h1>

      {/* Button in Foreground */}
      <Link to="/signup" className="relative px-10 py-4 bg-yellow-400 text-black font-bold rounded-xl shadow-lg hover:bg-yellow-500 transition">
        Start Studying
      </Link>
    </section>
      ...
      <div className="flex overflow-x-auto space-x-6 px-2 scrollbar-hide">
        {reviews.map((r, index) => (
          <div
            key={index}
            className="min-w-[300px] max-w-[300px] bg-gray-100 rounded-xl shadow-md p-6 flex-shrink-0"
          >
