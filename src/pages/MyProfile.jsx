...
const MyProfile = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-8 p-4 sm:p-8 text-white bg-gray-900 shadow-lg">
      {/* Heading */}
      <h1 className="text-2xl sm:text-3xl font-semibold">My Profile</h1>

      {/* Section 1: Basic Info */}
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 bg-gray-800 p-6 rounded-lg w-full">
        <img
          src={user?.image || "/default-avatar.png"}
          alt={`${user?.firstName}`}
          className="aspect-square w-24 sm:w-[100px] rounded-full object-cover border border-gray-700"
        />
